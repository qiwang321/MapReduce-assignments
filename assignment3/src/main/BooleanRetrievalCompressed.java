...
public class BooleanRetrievalCompressed extends Configured implements Tool {
  ...
  private Set<Integer> fetchDocumentSet(String term) throws IOException {
    ...
    ByteArrayInputStream postings = new ByteArrayInputStream(buffer);
    DataInputStream in = new DataInputStream(postings);    
    int cum = 0;
    
    while (in.available() != 0) {
    	cum = WritableUtils.readVInt(in) + cum; // integration
    	set.add(cum); 
    	WritableUtils.readVInt(in); //skip the frequency
    }
